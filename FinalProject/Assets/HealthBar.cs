...
public class HealthBar : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float healthBarScale = player.maxHealth / player.initialHealth;

        // Update health bar width based on health percentage (resizing from the left)
        healthPanel.sizeDelta = new Vector2(maxWidth * healthPercentage * healthBarScale, healthPanel.sizeDelta.y);
    }
}
